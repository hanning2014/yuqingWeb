...
var handlePanelAction = function () {
  ...
  $("[data-click=panel-collapse]").hover(function () {
    $(this).tooltip({title: "折叠 / 展开", placement: "bottom", trigger: "hover", container: "body"});
    $(this).tooltip("show");
  });
  ...
  $("[data-click=panel-reload]").hover(function () {
    $(this).tooltip({title: "刷新", placement: "bottom", trigger: "hover", container: "body"});
    $(this).tooltip("show")
  });
...
var handleThemePageStructureControl = function () {
  if ($.cookie && $.cookie("theme")) {
    ...
    var e = "/static/assets/css/theme/" + $.cookie("theme") + ".css";
    $("#theme").attr("href", e)
  }
  ...
  $(".theme-list [data-theme]").live("click", function () {
    var e = "/static/assets/css/theme/" + $(this).attr("data-theme") + ".css";
    $("#theme").attr("href", e);
